...
The table below is machine-generated from `dsv3_a4w4_pmc_summary.csv` by
`summarize.py` (re-collect via `collect.sh` regenerates both together).
...
|---|---|---|---|---|---|---|
| 32 | stage1 | 262 | 0.0133 | 0.1464 | 0.274 | 3.2 |
| 32 | stage2 | 1260 | **0.641** | 0.3885 | 0.119 | 3.8 |
| 64 | stage1 | 266 | 0.0148 | 0.1465 | 0.2738 | 3.0 |
| 64 | stage2 | 1680 | **0.7312** | 0.3909 | 0.1206 | 3.6 |
| 16384 | stage1 | 2561 | 0.023 | 0.1461 | 0.2706 | 14.7 |
| 16384 | stage2 | 16996 | **0.2302** | 0.5174 | 0.2566 | 28.5 |
| 32768 | stage1 | 4865 | 0.0307 | 0.1461 | 0.2705 | 48.0 |
| 32768 | stage2 | 33124 | **0.262** | 0.5208 | 0.2602 | 34.0 |
<!-- AUTOGEN:pmc-table END -->
...
- **Small-token grids are modest in workgroups but mostly empty.** stage2 launches
  1260/1680 workgroups for 32/64 tokens (E=257, per-expert block padding), and the
